...
<body style="margin: 1px">
	<table id="dg" title="销售机会信息管理" class="easyui-datagrid"
	       ...
	       url="${ctx}/saleChance/query" fit="true" toolbar="#tb">
		    <thead>
		    <tr>
		        ...
		        <table cellspacing="8px">
		            <tr>
		                ...
		                <td>
		                	...
		                	data-options="panelHeight:'auto',editable:false,valueField:'id',textField:'name', url:'${ctx}/customer/queryCustomerNames'" 
		                	/> &nbsp;<font color="red">*</font>
		                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		                <td>机会来源</td>
		            ...
		            <tr>
		                ...
		                <td><input class="easyui-combobox" id="assignMan" name="assignMan" 
		                	data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/queryManagerTrueNames'"/></td>
		                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
		            </tr>
		        </table>
		    </form>
...
<script src="${ctx}/js/sale_chance.js" ></script>
</html>